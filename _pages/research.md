...
- Examined how processing-location decisions shape smallholder participation in cross-border agricultural value chains, using China→US konjac trade as a case.
- Built an arrival-rate-conserving network-flow model to formalize trade-offs between "fresh → processed" conversion at origin vs. destination under different logistics and loss structures.
